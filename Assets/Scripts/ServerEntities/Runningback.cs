...
public class Runningback : Unit {
    public override float MoveSpeed { get { return Constants.MOVE_SPEED_RB; } }
    public override float ThrowRange { get { return Constants.THROW_RANGE_RB; } }
